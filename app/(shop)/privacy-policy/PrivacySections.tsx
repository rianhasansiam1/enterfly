...
/**
 * The numbered content sections of the Privacy Policy page.
  ...
  return (
    <>
      <PolicySection
        ...
        intro="EnterFly (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) operates an online shopping platform that lets customers browse, save, and purchase products. We respect your privacy and are committed to protecting the personal information you share with us."
      >
        <p>
          This Privacy Policy describes how we collect, use, store, and safeguard your information
          when you visit our website, create an account, use Google sign-in, or place an order as a
          guest. By using EnterFly, you agree to the practices described in this policy.
        </p>
      </PolicySection>

      <PolicySection
        title="2. Information We Collect"
        intro="We only collect information that helps us provide a smooth shopping experience and fulfill your orders. The data we collect falls into a few simple categories."
      >
        <p className="font-semibold text-gray-900">Information you provide directly:</p>
        <PolicyList
          items={[
            "Account details: name, email address, and password (stored securely in hashed form)",
            "Google account details when you sign in with Google (name, email, profile picture)",
            "Shipping and contact information: delivery address, phone number, and recipient name",
            "Order information: products purchased, quantities, and payment method (such as Cash on Delivery)",
            "Optional reviews, ratings, and feedback you submit on products",
          ]}
        />
