...
/**
 * The numbered content sections of the Terms & Conditions page.
  ...
  return (
    <>
      <PolicySection
        ...
        intro="Welcome to EnterFly. These Terms & Conditions (&quot;Terms&quot;) govern your access to and use of our website, products, and services (collectively, the &quot;Site&quot;)."
      >
        <p>
          By browsing EnterFly, creating an account, signing in with Google, or placing an order as a
          guest, you confirm that you have read, understood, and agreed to these Terms. If you do not
      ...
      <PolicySection
        title="2. Eligibility"
        intro="To use EnterFly, you must:"
      >
        <PolicyList
          items={[
            "Be at least 18 years old, or use the Site under the supervision of a parent or legal guardian",
            ...
            "Use the Site only for lawful, personal, and non-commercial purposes",
          ]}
        />
      </PolicySection>
