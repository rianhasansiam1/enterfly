...
const socials = [
  ...
  },
  {
    name: "Instagram",
    href: "#",
    bg: "bg-linear-to-br from-fuchsia-600 via-pink-500 to-amber-500",
    handle: "@enterfly",
    icon: (
      <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
